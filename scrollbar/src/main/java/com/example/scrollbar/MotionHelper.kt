...
object MotionHelper {
    fun isInViewTouchTarget(
        ...
        return isInTouchTarget(
            x, view.left - scrollX, view.right - scrollX, 0, parentView.width, minTouchTargetSize
        ) && isInTouchTarget(
            y, view.top - scrollY, view.bottom - scrollY, 0, parentView.height, minTouchTargetSize
    ...
    private fun isInTouchTarget(
        ...
        parentStart: Int,
        parentEnd: Int,
        minTouchTargetSize: Int): Boolean {
