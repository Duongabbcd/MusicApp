...
class WheelPicker @JvmOverloads constructor(
    ...
    var centerItemColor : Int = 0
        set(value) {
            field = value

        }

    var otherItemColor : Int = 0
        set(value) {
            field = value
        }

    var defaultCenterTextSize : Float = 0F
        set(value) {
            field = value
        }
    ...
    init {
        ...
        centerItemColor = a.getInt(R.styleable.WheelPicker_center_item_color, 0)
        otherItemColor = a.getInt(R.styleable.WheelPicker_other_item_color, 0)
        defaultCenterTextSize = a.getFloat(R.styleable.WheelPicker_center_text_size, 0f)
